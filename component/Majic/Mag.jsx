...
export default function Mag() {
  ...
  return (
    <div className='product grid '>
          ...
          e.map((ele,index)=>{
            return(
              <div className="cart majic p-3 relative bg-slate-100 border-2 border-yellow-200 border-solid" key={index}>
                <div className="img  h-52">
                    <Image  src={require(`/public/img3/prx (${index + 1}).jpg`)}  alt="My Image"  width={500} height={400} className='h-full'/>
                </div>
                <div className="protvi absolute p-3 w-full h-full bg-slate-600 top-0 right-0 opacity-0 ">
                <div className="text p-2 mt-2 h-full flex flex-col justify-between">
